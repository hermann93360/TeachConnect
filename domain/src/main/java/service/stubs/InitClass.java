...
import static service.stubs.ApplicationDataStub.applications;
import static service.stubs.JobOfferDataStub.jobOffers;
...
public class InitClass {
    public static void initData() {
        ...
        UserDataStub.users.put(schoolUser1.getUserId(), schoolUser1);
        UserDataStub.users.put(schoolUser2.getUserId(), schoolUser2);

        UserDataStub.users.put(teacherUser1.getUserId(), teacherUser1);
        UserDataStub.users.put(teacherUser2.getUserId(), teacherUser2);
        UserDataStub.users.put(teacherUser3.getUserId(), teacherUser3);

        UserDataStub.users.put(commercialUser1.getUserId(), commercialUser1);
        UserDataStub.users.put(commercialUser2.getUserId(), commercialUser2);
        ...
        SchoolDataStub.schools.put(school1.getSchoolId(), school1);
        SchoolDataStub.schools.put(school2.getSchoolId(), school2);
        ...
        TeacherDataStub.teachers.put(teacher1.getTeacherId(), teacher1);
        TeacherDataStub.teachers.put(teacher2.getTeacherId(), teacher2);
        TeacherDataStub.teachers.put(teacher3.getTeacherId(), teacher3);
